...
export const metadata: Metadata = {
  title: "Contact Us - FinBuzz",
  description: "Get in touch with FinBuzz for a free consultation. Contact our business experts to discuss your transformation needs.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Ready to transform your business? Get in touch with our experts for a free consultation and discover how we can help you achieve your goals.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@finbuzz.com" className="text-gray-600 hover:text-blue-600 transition-colors">contact@finbuzz.com</a>
                  </div>
                </div>
